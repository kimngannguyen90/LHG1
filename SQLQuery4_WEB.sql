...
CASE WHEN (SELECT COUNT(*)
	...
	,(CASE WHEN PER_DETAIL.Position_NAME =N'C?NG NH?N' AND PER_DETAIL.Youth_Union_Place NOT IN (N'V?NG NGO?I',N'giao nh?n',N'S?p vi?c') THEN  'DERECT' ELSE 'INDERECT' END ) TYPESS	
